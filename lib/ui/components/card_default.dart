...
class CardDefault extends StatelessWidget {
  ...
  double totalExpense;
  Function iconButton;
  CardDefault(this.name,this.isVisibility, this.total, this.iconButton,this.totalIncome,this.totalExpense,{super.key});
        ...
        child: Row(
          ...
          children: [
            Column(
              ...
              children: [
                Text("Olá $name", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 14)),
                SizedBox(height: 10),
